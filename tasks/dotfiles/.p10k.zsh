# Generated by Powerlevel10k configuration wizard on 2022-02-03 at 10:57 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 53041.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# angled separators, sharp heads, flat tails, 1 line, concise, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#FFA8C7'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#59D0FE'
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=177
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=222
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=121
  # Custom icon.
